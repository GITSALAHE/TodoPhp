            ...
            <div class="card-box" style="background-color: <?php echo $colorTodo ?> !important">
                ...
                <div style="color: white;font-family:poppins">
                    <?php foreach ($allTasks as $task) : ?>
                        ...
                        ?>
                            <a href="editTask.php?done=0&idtask=<?php echo $task['idTs'] ?>&idtodo=<?php echo $task['idTd'] ?>" class="btn btn-primary a-btn-slide-text">
                                <span class="glyphicon glyphicon-add" aria-hidden="true"></span>
                                <span><strong>Unfinished it ?</strong></span>
                            </a>

                        <?php } else {
                            echo "<p>Situation : Unfinishid</p>";
                        ?>
                            <a href="editTask.php?done=1&idtask=<?php echo $task['idTs'] ?>&idtodo=<?php echo $task['idTd'] ?>" class="btn btn-primary a-btn-slide-text">
                                <span class="glyphicon glyphicon-add" aria-hidden="true"></span>
                                <span><strong>finish it ?</strong></span>
                            </a>
                        ...
                        <a href="editTask.php?idtodo=<?php echo $task['idTd'] ?>&idtask=<?php echo $task['idTs'] ?>" class="btn btn-primary a-btn-slide-text">
                            <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                            <span><strong>edit it ?</strong></span>
                        </a>
                        <a href="editTask.php?idTd=<?php echo $task['idTd'] ?>&del_idTs=<?php echo $task['idTs'] ?>" class="btn btn-primary a-btn-slide-text">
                                <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                                <span><strong>delete it ?</strong></span>
                            </a>
